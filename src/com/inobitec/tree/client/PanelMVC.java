...
//    private static final String STYLE_ALL_NODES_TABLE = "all-nodes-table";
    ...
    private void build() {
        ...
        allNodesPanelPresenter = new AllNodesPanelPresenter(new AllNodesPanelView(STYLE_ALL_NODES_HEADER, WRAPPER_AN_TABLE));
    }

    private void doShit() {
        crudPanelPresenter.setCommand(new Command() {
